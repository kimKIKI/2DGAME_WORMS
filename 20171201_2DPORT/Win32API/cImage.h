...
private:
	...
	HBITMAP GetHBITMAPFromImageFile(const char* pFilePath);
...
public:
	...
	// 이미지 파일 셋업
	void SetupImage(const char* fileName, int width, int height,
	...
	//     # PNG 이미지 셋업
	//=====================================================================
	void SetupFrameImagePNG(const char* fileName, int width, int height, int frameX, int frameY,
		int x, int y, bool isTrans = false, COLORREF transColor = RGB(0, 0, 0));
